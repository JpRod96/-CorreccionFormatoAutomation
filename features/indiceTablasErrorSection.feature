...
Scenario: Showing table index error messages
...
Scenario: Showing table index error message, validating Indice Tablas should be numbered 
    When I click on the "Índice de Tablas" section
...
Scenario: Showing table index error message, validating Indice Tablas alignment
    When I click on the "Índice de Tablas" section
